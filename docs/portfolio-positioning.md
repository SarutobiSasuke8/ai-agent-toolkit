...
`ai-agent-toolkit` is not just a prompt wrapper.

It demonstrates a practical agent pattern:

- use a tool to gather source material
- route that material into a model
- apply a clear voice specification
- produce a reusable output format

## What It Signals

For a recruiter, client, or collaborator, this repo shows:
